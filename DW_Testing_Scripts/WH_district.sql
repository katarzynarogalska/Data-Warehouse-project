...
-- 4 SCD 2 
insert into StagingDistrictTable(DistrictName, AvgPopulation, ShareOfTotalPopulation, TotalSNAPRecipients, TotalCashAssistanceRecipients, TotalMedicaidRecipients)
values ('BRONX', 1800000, 50.07, 38121,11344, 32418)

select * from DistrictDetailsDim

select * from EMSFacts